            ...
            <footer class="text-center bg-gray-900 text-white">
                <div class="container px-2 pt-2">
                    <div class="flex justify-between">
                        ...
                        <div class="ml-36">
                            <img style={{ width: 50 }} class="text-left" src="https://images.unsplash.com/photo-1599305445671-ac291c95aaa9?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=869&q=80" alt="" />
                        </div>

                        <div class="text-center mt-2">
                            © 2022 Copyright : Lovely Cat
                        </div>
